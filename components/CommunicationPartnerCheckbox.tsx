...
interface CommunicationPartnerCheckboxProps {
  id: string;
  name: string;
  description?: string;
  icon: {
...
const CommunicationPartnerCheckbox: React.FC<CommunicationPartnerCheckboxProps> = ({
  id,
  name,
  description,
  icon,
...
export default CommunicationPartnerCheckbox;